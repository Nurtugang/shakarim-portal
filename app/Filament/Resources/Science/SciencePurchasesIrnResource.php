...
use App\Filament\Resources\Science\SciencePurchasesIrnResource\Pages;
use App\Filament\Resources\Science\SciencePurchasesIrnResource\RelationManagers;
...
class SciencePurchasesIrnResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ManageSciencePurchasesIrns::route('/'),
        ];
    }
}
