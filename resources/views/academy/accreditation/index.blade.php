                        ...
                        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                            <div class="p-6 space-y-8">
                                ...
                                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                                    ...
                                    <p class="text-gray-700 text-sm">
                                        {{ __('Результаты рейтинга образовательных программ Университета Шакарима были представлены на официальном сайте')}} <a href="https://atameken.kz/ru/university_ratings">{{ __('Национальной палаты предпринимателей Республики Казахстан «Атамекен».')}}</a>
                                    </p>
                                </div>
                            </div>
                        </div>
