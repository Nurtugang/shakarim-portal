        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="lg:w-3/4">
                ...
                <div id="content-about" class="tab-content">
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        <div class="mb-6">
                            <img src="{{ asset('img/about.jpg') }}" alt="{{ __('Университет Шакарима') }}" class="w-full object-centre h-72 object-cover rounded-lg shadow-md">
                        </div>
                        <div class="prose max-w-none text-gray-700 space-y-4">
                            <p><strong>{{ __('Шәкәрім университет — современный учебно-методический, научный и культурный центр Северо-Восточного региона Казахстана.') }}</strong></p>
                            <p>{{ __('Шәкәрім университет был создан на базе педагогического, зооветеринарного, финансово-экономического и технологического институтов.') }}</p>
                            <p>{{ __('Шәкәрім университет — это многопрофильное высшее учебное заведение с богатым опытом работы.') }}</p>
                            <p>{{ __('В Шәкәрім университете в пяти высших школах и трех научно-исследовательских школах обучаются около 7 тысяч студентов, магистрантов и докторантов по 72 образовательным программам бакалавриата, 60 программам магистратуры и 10 программам PhD-докторантуры.') }}</p>
                            <p>{{ __('Шәкәрім университет — это высококвалифицированный профессорско-преподавательский состав, включающий 760 преподавателей и сотрудников, среди которых 78 докторов наук и профессоров, 135 кандидатов наук и доцентов, 161 магистр.') }}</p>
                            <p>{{ __('Шәкәрім университет — ВУЗ, в котором 70 ученых являются обладателями государственной грантовой программы «Лучший преподаватель вуза».') }}</p>
                            <p>{{ __('Шәкәрім университет располагает качественной учебно-методической и развитой материально-технической базой: 12 учебных корпусов, учебные и научные лаборатории и мастерские, оснащенные современным оборудованием, научная библиотека с фондом более 700 тысяч изданий, медиатека и читальный зал, компьютерный парк (более 1300 компьютеров), бассейн и два тренажёрных зала, два спортивных комплекса с оборудованными футбольными полями, спортивный зал, медицинский центр с лечебно-профилактическим оборудованием, Студенческий дом и общежития квартирного типа.') }}</p>
                            <p>{{ __('Шәкәрім университет— крупное высшее учебное заведение с широкими международными связями. Университет сотрудничает с вузами США, Китая, Монголии, Германии, Нидерландов, Великобритании, Японии, Турции, Чехии, Словении, Польши, России, Беларуси, Украины и стран Балтии, а также является членом авторитетных международных организаций.') }}</p>
                            <p>{{ __('Шәкәрім университет— это учебное заведение с развитой инфраструктурой, высоким научным потенциалом и устойчивым международным авторитетом, ориентированное на подготовку конкурентоспособных специалистов. Достижения и возможности университета обеспечивают обучающимся качественное образование и условия для всестороннего развития.') }}</p>
                        </div>
                    </div>
                </div>
