<x-layout>
    <!-- Hero Section -->
    <div class="bg-gradient-to-r from-shakarim-blue to-blue-700 text-white py-16">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center">
                <h1 class="text-3xl md:text-4xl font-bold mb-4">{{ __('Endowment') }}</h1>
                <p class="text-lg md:text-xl text-blue-100">{{ __('Make a contribution to the development of the university') }}</p>
            </div>
        </div>
    </div>
