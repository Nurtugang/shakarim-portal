...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement('ALTER TABLE page_lists ADD FULLTEXT search_kk(title_kk, content_text_kk)');
        DB::statement('ALTER TABLE page_lists ADD FULLTEXT search_ru(title_ru, content_text_ru)');
        DB::statement('ALTER TABLE page_lists ADD FULLTEXT search_en(title_en, content_text_en)');
    }
